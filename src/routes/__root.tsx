...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#4A2C2A" },
      { title: "Online Mobiles — Premium Mobiles, Repairs & Accessories" },
      { name: "description", content: "Buy new & pre-owned smartphones, accessories, and get expert repairs. Genuine products, transparent prices, warranty on every service." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Online Mobiles" },
